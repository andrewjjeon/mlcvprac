...
from wires import evaluate_function, get_board, gridify_board
...
class TestEvaluateFunction(unittest.TestCase):
    ...
    def test_and(self):
        board = get_board('and')
        self._test_two_inputs(board, lambda a, b: a and b) # lambda is a small anonymous function args : function
